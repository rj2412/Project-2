...
function checkemail(email)
{
    if(email.length >8 && email.includes('@gmail'))
    {
        ...
        document.getElementById('email_error').innerText='Enter valid email & it should be 8 letters long'
...
function checkpasswordsmatch(password,cpassword)
{
     if(password==cpassword && password!='')
     {
        ...
        document.getElementById('cpassword_error').innerText='Password doesnt match'
     }
